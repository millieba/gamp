// This function can be used to test whether the data returned from the GitHub API is as expected. 
// E.g. if you know which repos you expect to be returned, you can compare the returned data to that.
function comparer(inputObj: any) {
    // Variable with the data to compare to. Replace with the data you want to compare to. 
